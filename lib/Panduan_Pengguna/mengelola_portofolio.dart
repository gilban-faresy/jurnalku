...
class MengelolaPortofolioPage extends StatefulWidget {
  ...
  @override
  State<MengelolaPortofolioPage> createState() =>
      _KelengkapanProfilePageState();
}
            ...
            Text.rich(
              TextSpan(
                ...
                children: [
                  TextSpan(
                    text:
                        "1. Buka profil Anda (klik foto profil atau nama Anda), kemudian klik tab ",
                  ),
                  TextSpan(
                    text: "Portfolio.",
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: "Penjelasan detail tentang project (wajib)",
                        ),
                      ],
                    ),
                  ),
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              "Waktu pengerjaan, contoh: \"3 bulan\", \"2 minggu\" (wajib)",
                        ),
                      ],
                    ),
                  ),
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text: "URL project jika ada (opsional, harus valid)",
                        ),
                      ],
                    ),
                  ),
            ...
            Text.rich(
              TextSpan(
                ...
                children: [
                  TextSpan(
                    text:
                        "1. Temukan portfolio yang ingin diedit pada halaman ",
                  ),
                  TextSpan(
                    text: "Portfolio.",
                    style: TextStyle(fontWeight: FontWeight.bold),
            ...
            Text.rich(
              TextSpan(
                ...
                children: [
                  TextSpan(
                    text:
                        "1. Temukan portfolio yang ingin dihapus pada halaman ",
                  ),
                  TextSpan(
                    text: "Portfolio.",
                    style: TextStyle(fontWeight: FontWeight.bold),
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              "Periksa apakah semua field wajib sudah diisi dengan benar",
                        ),
                      ],
                    ),
                  ),
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              "Pastikan ukuran gambar tidak melebihi 2MB dan format yang didukung (JPG, PNG, GIF)",
                        ),
                      ],
                    ),
                  ),
                  ...
                  Text.rich(
                    TextSpan(
                      ...
                      children: [
                        ...
                        TextSpan(
                          text:
                              "Sistem sekarang mendukung line break, pastikan browser Anda sudah di-refresh jika masih mengalami masalah",
                        ),
                      ],
                    ),
                  ),
